...
var ajax = new XMLHttpRequest(); // 네트워크 너머에 있는 도구를 가져온다.

var news_url = 'https://api.hnpwa.com/v0/news/1.json';
var content_url = "https://api.hnpwa.com/v0/item/@id.json";
var container_tg = document.getElementById("root");
...
function NewsFead_code() {
  var MAX_PAGE_LIST_CNT = 10;
  var newsFead = GetData(news_url);
  var newsList = [];
  for (var i = (store.iCurrentPage - 1) * MAX_PAGE_LIST_CNT; i < store.iCurrentPage * MAX_PAGE_LIST_CNT; ++i) {
    newsList.push("\n    <li>\n        <a href=\"#/show/".concat(newsFead[i].id, "\">\n            ").concat(newsFead[i].title, "(").concat(newsFead[i].comments_count, ")\n        </a>\n    </li>\n    "));
  }
  ;
...
;
function NewsDetail() {
  var id = location.hash.substr(7); // 1부터 마지막 인덱스 영역까지 자르기
  var newsContent = GetData(content_url.replace("@id", id));
  container_tg.innerHTML = "\n        <h1>".concat(newsContent.title, "</h1>\n        <div>\n            <a href=\"#/page/").concat(store.iCurrentPage, "\">\uBAA9\uB85D\uC73C\uB85C</a>\n        </div>\n    ");
}
;
function Router() {
...
},{}],"C:/Users/jjangmen/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/jjangmen/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","app.js"], null)
