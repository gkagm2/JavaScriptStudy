...
{ 
  ...
  { 
    ...
    { 
      ...
      { 
        ...
        if (i) 
          return 
        i(o, !0); var f = new Error("Cannot find module '" + o + "'"); 
        throw f.code = "MODULE_NOT_FOUND", f } var l = n[o] = { exports: {} }; t[o][0].call(l.exports, function (e) { var n = t[o][1][e]; return s(n ? n : e) }, l, l.exports, e, t, n, r) } return n[o].exports } var i = typeof require == "function" && require; for (var o = 0; o < r.length; o++)s(r[o]); return s })({
  1: [function (require, module, exports) {
    ...
    module.exports = {
      ...
      , _focusZoom: function (instance, _x, _y) {
        // focus
    ...
    ShadowViewport.prototype.getCTM = function () {
      ...
      console.log("safeCTM.a" + safeCTM.a +", b" + safeCTM.b + ", c" + safeCTM.c + " ,d"  + safeCTM.d +", e" + safeCTM.e +", f" +safeCTM.f);
    ...
    SvgPanZoom.prototype.zoomAtPoint = function (zoomScale, point, zoomAbsolute) {
      console.log("zoomAtPoint : " + zoomScale, point, zoomAbsolute);
    ...
    SvgPanZoom.prototype.computeFromRelativeZoom = function (zoom) {
      console.log("computeFromRelativeZoom : " + zoom + ", " + zoom * this.viewport.getOriginalState().zoom);
